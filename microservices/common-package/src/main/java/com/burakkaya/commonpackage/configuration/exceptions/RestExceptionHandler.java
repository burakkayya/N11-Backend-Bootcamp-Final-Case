...
public class RestExceptionHandler {
    ...
    public ExceptionResult<Object> handleRuntimeException(RuntimeException exception){
        if(exception.getMessage().contains("Access Denied")) return new ExceptionResult<>(ExceptionTypes.Exception.AccessDenied, new AccessDeniedException("Access Denied").getMessage());
